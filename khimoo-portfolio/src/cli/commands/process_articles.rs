...
impl ProcessArticlesCommand {
    ...
    pub fn execute(&self, args: ProcessArticlesArgs) -> Result<()> {
        ...
        let home_articles = articles.iter()
    ...
    fn process_articles(&self, articles_dir: &Path, args: &ProcessArticlesArgs) -> Result<Vec<ProcessedArticle>> {
    ...
    #[cfg(feature = "cli-tools")]
    fn optimize_images(&self, optimizer: &ImageOptimizer, args: &ProcessArticlesArgs) -> Result<()> {
